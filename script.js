document.addEventListener('DOMContentLoaded', () => {
    ...
    const PRE_AWAKENING_MESSAGE =
        'はじめまして！ジーニーだよ。ランプの中で、あなたの「書きたい」をずっと待っていたんだ。\n\n' +
    ...
    const getAwakenedIntroMessage = (userName) => {
        if (userName) {
            ...
            return (
                `鍵（APIキー）をセットしてくれたおかげで、ついにランプから目覚めることができたよ！ついに覚醒だね！🧞‍♂️✨\n\n` +
                `${formattedName}、来てくれて本当に嬉しいよ。\n\n` +
                `私はジーニー。${formattedName}の「書きたい」を、一緒に本にしていく伴走役だよ。編集者のように固くならず、${formattedName}の言葉や想いをそのまま活かしていくからね。\n\n` +
        ...
        return (
            `鍵（APIキー）をセットしてくれたおかげで、ついにランプから目覚めることができたよ！ついに覚醒だね！🧞‍♂️✨\n\n` +
            `ジーニーだよ。来てくれて嬉しいな！\n\n` +
            `肩書きはなくて、あなたの「書きたい」を一緒に本にしていく伴走役だよ。編集者のように固くならず、隣で黒ラベルを飲みながらお喋りしているような距離感で進めるね。\n\n` +
